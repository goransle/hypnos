...
const today = Moment();
var defaultData = { bedtime: "23:00", waketime: '07:25', rating: 5, troubleSleeping: 0 };
        ...
        <div className="App">
          ...
          <Route exact path="/" render={props => (
            <React.Fragment>
              ...
              <Logging day={this.state.selectedDay} data={this.state.logData} inputHandler={this.inputHandler} state={props} />
            </React.Fragment>
          )} />
